 ...
 * PSGConverter.js
 * v2.1
 * Copyright (c)2007-2013,2018,2019 Logue <http://logue.be/> All rights reserved.
 *
...
(function (definition) {
  ...
  PSGConverter.prototype.messages = {
    'en': {
      ...
      'Chello': 'Chello',
      'Harp': 'Harp',
      'Lute_renew': 'Lute (Renew)',
      'Ukulele_renew': 'Ukulele (Renew)',
      'Mandolin_renew': 'Mandolin (Renew)',
      'Whistle_renew': 'Whistle (Renew)',
      'Flute_renew': 'Flute (Renew)',
      'Flute_nonvib': 'Flute (Non-Vib)',
      'Whistle_nonvib': 'Whistle (Non-Vib)',
      'Snare': 'Snare',
      'Drum': 'Drum',
      'Bass Drum': 'Bass Drum',
      'Cymbal': 'Cymbal',
    ...
    ja: {
      ...
      'Chello': 'チェロ',
      'Harp': 'ハープ',
      'Lute_renew': 'リュート (Renew)',
      'Ukulele_renew': 'ウクレレ (Renew)',
      'Mandolin_renew': 'マンドリン (Renew)',
      'Whistle_renew': 'ホイッスル (Renew)',
      'Flute_renew': 'フルート (Renew)',
      'Flute_nonvib': 'フルート (Non-Vib)',
      'Whistle_nonvib': 'ホイッスル (Non-Vib)',
      'Snare': 'スネア',
      'Drum': '小太鼓',
      'Bass Drum': '大太鼓',
      'Cymbal': 'シンバル',
