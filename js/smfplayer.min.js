...
0};else if("END"===f[1]&&d.s){k=h[f[2]|0];if(0!==k.count){0<k.count&&k.count--;i=k.pos;d.d=setTimeout(a,0);d.position=i;return}h[f[2]|0]=q}g.postMessage(c[i++].webMidiLink,"*")}while(i<l&&c[i].time===b);i<l?(m=Date.now()-m,d.d=setTimeout(a,d.f/(1E3*e)*(c[i].time-b-m)*(1/d.F))):window.postMessage('endoftrack','*')||d.p&&h[0]&&"number"===typeof h[0].pos?(i=h[0].pos,d.d=setTimeout(a,0)):d.r&&(b=d,b.f=5E5,b.position=0,R(d));d.position=i}}var d=b,e=b.B.T,c=b.g,g=b.b.contentWindow,i=b.position||0,h=[];b.pause?(b.d=setTimeout(a,b.e),b.pause=
